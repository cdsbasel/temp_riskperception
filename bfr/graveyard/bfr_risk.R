...
dates <-read_excel("C:\\Users\\holze\\Documents\\bfr\\data\\risks.xlsx")
dates <- dates %>% 
  mutate(date= start + (end-start)/2) 

data=read_excel("C:\\Users\\holze\\Documents\\bfr\\data\\risks.xlsx")
...
model1=lmer(value~1+(1|risk),data=df1)
summary(model1)
